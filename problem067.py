...
#Find the maximum total from top to bottom of problem_data/p067_data.txt, you can only move to adjacent numbers, when viewing as a pyramid

def printPyramid(pyramid):
    for i in range(len(pyramid)):
        print(pyramid[i])   
    
f = open("problem_data/p067_data.txt",'r')
